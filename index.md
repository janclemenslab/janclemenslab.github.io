...
- During __acoustic communication__  for courtship the sender produces a temporally structured signal - a song. The receiver parses that song - for instance to learn about the species or quality of the sender. However, acoustic communication in the wild is much more complex than this simplistic description implies: Eavesdroppers glean information from signals intended for others; Conflicts between sender and receiver shape the signals and the circuits that process these signals. We study acoustic communication with this full complexity in mind.
