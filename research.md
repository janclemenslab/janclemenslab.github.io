...
<div class="research-overview">
    <p class="research-intro">We study how animals produce, process, and act on acoustic signals. Our work combines behavioral experiments, neural recordings, computational modeling, and machine learning tools that make complex communication and navigation behavior measurable.</p>

    <section class="research-topic" id="animal-sound-analysis">
        <p class="section-kicker">Audio AI / ML tools</p>
        <h2>Building tools for animal sound analysis.</h2>
        <p class="research-topic__text">We develop machine learning tools for detecting, segmenting, and quantifying animal sounds. DAS is used by labs studying flies, zebra finches, nightingales, parrots, gerbils, mice, bats, and chimpanzees, helping researchers turn large audio recordings into structured data for behavioral and neural analysis.</p>
    </section>
